  ...
  const handleRemoveItem = async (itemId) => {
    ...
    try {
      ...
      if (infocartCookie) {
        ...
        // Realiza la petición a la ruta "/cart/remove" para eliminar el artículo completamente
        await axiosInstance.delete("/cart/remove", {
          data: {
            id_cart: cartId,
            id_producto: itemId,
            cantidad: 0, // Decrementar en 1
          },
        });
                              ...
                              <MDBCol>
                                ...
                                <p>
                                  ...
                                  <MDBBtn
                                    ...
                                    className="ms-2"
                                    onClick={() =>
                                      handleRemoveItem(item.id_producto)
                                    }
                                  >
                                    Eliminar
                                  </MDBBtn>
                ...
                <MDBRow className="mt-3">
                  <MDBCol>
                    ...
                    {isProfileIncomplete && (
                      ...
                      >
                        Por favor diríjase a su perfil y complete su
                        información.
                      </span>
                    )}
                    {!modoPago && (
