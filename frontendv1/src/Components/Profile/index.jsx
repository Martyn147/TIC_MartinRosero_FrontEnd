...
export const Profile = () => {
  const [isLoading, setIsLoading] = useState(true); // Estado para indicar si las peticiones están en progreso
  ...
  useEffect(() => {
    ...
    const fetchProfileData = async () => {
      try {
        ...
        setIsLoading(false); // Ocultar pantalla de carga cuando termina la petición
      }
    };
  ...
  const handleSaveChanges = async () => {
    if (
      !editedProfile.nombres ||
      !editedProfile.apellidos ||
      !editedProfile.telefono ||
      !editedProfile.direccion
    ) {
    ...
    try {
      ...
      setIsLoading(true); // Mostrar pantalla de carga al enviar la petición
                  ...
                  <div className="d-flex justify-content-between">
                    {!editMode ? (
                      ...
                      <div className="d-flex my-4">
                        <MDBBtn color="danger" onClick={() => setEditMode(false)}>
                          Cancelar
                        </MDBBtn>
                        <MDBBtn color="success" onClick={handleSaveChanges} className="ms-2">
                          Guardar Cambios
                        </MDBBtn>
                      </div>
                    )}
