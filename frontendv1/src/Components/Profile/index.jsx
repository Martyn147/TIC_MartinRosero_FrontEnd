...
export const Profile = () => {
  ...
  const [editedProfile, setEditedProfile] = useState({
    ...
    apellidos: '',
    telefono: '',
    direccion: '', // La dirección se inicia como vacía
  });
  ...
  useEffect(() => {
    ...
    const fetchProfileData = async () => {
      try {
        ...
        setEditedProfile(response.data[0]); // Inicializa los datos editados con los datos del perfil actual
      } catch (error) {
  ...
  const handleSaveChanges = async () => {
    // Validamos que todos los campos sean llenados antes de guardar los cambios
    ...
    try {
      ...
      // Realiza la petición PUT a la ruta "/profile/update" con los datos editados
